...
<body>
    ...
    <header>
        <div class="logo-area">
            <h1 style="display: flex; align-items: center; gap: 0.5rem; text-transform: none; letter-spacing: normal;">directeur<span style="color: var(--accent); font-weight: 800;">AI</span> <span style="font-size: 0.75rem; font-weight: 600; opacity: 0.8; background: rgba(255,255,255,0.08); padding: 0.15rem 0.4rem; border-radius: 4px; letter-spacing: 0.05em; text-transform: uppercase;">dsAI</span></h1>
